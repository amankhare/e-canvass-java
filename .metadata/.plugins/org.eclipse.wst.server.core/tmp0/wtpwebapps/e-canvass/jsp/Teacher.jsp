...
<%}else{ %>
<div><a href="/e-canvass/jsp/sentbox.jsp?Teacher">Sentbox(<%=rs2.getInt(1) %>)</a></div><%} %>
<% if(flag!=1)
{%>
<div><a href="/e-canvass/jsp/inbox.jsp?Teacher">Inbox(0)</a></div>
<%}else{ %>
<div><a href="/e-canvass/jsp/inbox.jsp?Teacher">Inbox(<%=rs0.getInt(1) %>)</a></div><%} %>
...
<form action="/e-canvass/Post_text" method="Get">
